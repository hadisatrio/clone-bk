...
export default function Footer() {
  return (
    <footer aria-label="Site Footer" className="bg-neutral-800">
      <div className="mx-auto max-w-4xl px-4 pt-12 pb-6 sm:px-6 lg:pt-16">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div className="flex items-center justify-center sm:justify-start">
              ...
              />
              <p className="font-bold text-xl text-gray-100 pl-4">
                Burger King
              </p>
            </div>

            <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-200  sm:mx-0 sm:max-w-xs sm:text-left">
            ...
            <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-orange-600 transition hover:text-orange-600/75"
                >
              ...
              <ul className="mt-8 space-y-4 text-sm">
                <li>
                  ...
                  >
                    ...
                    <span className="text-gray-200">john@doe.com</span>
                  </a>
                </li>
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="text-gray-200">0123456789</span>
                  </a>
                </li>
                ...
                <li className="flex items-start justify-center gap-1.5 sm:justify-start">
                  ...
                  <address className="-mt-0.5 not-italic text-gray-200">
                    Jakarta, Indonesia
                  </address>
                </li>
              </ul>
